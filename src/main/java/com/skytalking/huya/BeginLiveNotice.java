...
public final class BeginLiveNotice extends JceStruct implements Cloneable {
    ...
    public BeginLiveNotice(long var1, int var3, String var4, int var5, int var6, ArrayList<StreamInfo> var7, ArrayList<String> var8, long var9, int var11, int var12, int var13, long var14, String var16, long var17, long var19, int var21, int var22, ArrayList<MultiStreamInfo> var23, String var24, long var25, String var27, int var28, String var29, String var30, int var31, long var32, long var34, String var36, int var37) {
    ...
    public boolean equals(Object var1) {
        if (this != var1) {
            if (var1 != null && this.getClass() == var1.getClass()) {
                ...
                if (JceUtil.equals(this.lPresenterUid, var2.lPresenterUid) && JceUtil.equals(this.iGameId, var2.iGameId) && JceUtil.equals(this.sGameName, var2.sGameName) && JceUtil.equals(this.iRandomRange, var2.iRandomRange) && JceUtil.equals(this.iStreamType, var2.iStreamType) && JceUtil.equals(this.vStreamInfo, var2.vStreamInfo) && JceUtil.equals(this.vCdnList, var2.vCdnList) && JceUtil.equals(this.lLiveId, var2.lLiveId) && JceUtil.equals(this.iPCDefaultBitRate, var2.iPCDefaultBitRate) && JceUtil.equals(this.iWebDefaultBitRate, var2.iWebDefaultBitRate) && JceUtil.equals(this.iMobileDefaultBitRate, var2.iMobileDefaultBitRate) && JceUtil.equals(this.lMultiStreamFlag, var2.lMultiStreamFlag) && JceUtil.equals(this.sNick, var2.sNick) && JceUtil.equals(this.lYYId, var2.lYYId) && JceUtil.equals(this.lAttendeeCount, var2.lAttendeeCount) && JceUtil.equals(this.iCodecType, var2.iCodecType) && JceUtil.equals(this.iScreenType, var2.iScreenType) && JceUtil.equals(this.vMultiStreamInfo, var2.vMultiStreamInfo) && JceUtil.equals(this.sLiveDesc, var2.sLiveDesc) && JceUtil.equals(this.lLiveCompatibleFlag, var2.lLiveCompatibleFlag) && JceUtil.equals(this.sAvatarUrl, var2.sAvatarUrl) && JceUtil.equals(this.iSourceType, var2.iSourceType) && JceUtil.equals(this.sSubchannelName, var2.sSubchannelName) && JceUtil.equals(this.sVideoCaptureUrl, var2.sVideoCaptureUrl) && JceUtil.equals(this.iStartTime, var2.iStartTime) && JceUtil.equals(this.lChannelId, var2.lChannelId) && JceUtil.equals(this.lSubChannelId, var2.lSubChannelId) && JceUtil.equals(this.sLocation, var2.sLocation) && JceUtil.equals(this.iCdnPolicyLevel, var2.iCdnPolicyLevel)) {
                    return true;
                } else {
                    return false;
                }
    ...
    public void readFrom(JceInputStream var1) {
        ...
        this.vStreamInfo = (ArrayList)var1.read(cache_vStreamInfo, 5, false);
        if (cache_vCdnList == null) {
            cache_vCdnList = new ArrayList();
            cache_vCdnList.add("");
        }

        this.vCdnList = (ArrayList)var1.read(cache_vCdnList, 6, false);
        ...
        this.vMultiStreamInfo = (ArrayList)var1.read(cache_vMultiStreamInfo, 17, false);
