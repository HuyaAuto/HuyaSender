    ...
    public boolean equals(Object var1) {
        if (this != var1) {
            if (var1 != null && this.getClass() == var1.getClass()) {
                ...
                if (JceUtil.equals(this.lPresenterUid, var2.lPresenterUid) && JceUtil.equals(this.iBitRate, var2.iBitRate) && JceUtil.equals(this.iResolution, var2.iResolution) && JceUtil.equals(this.iFrameRate, var2.iFrameRate) && JceUtil.equals(this.lLiveId, var2.lLiveId) && JceUtil.equals(this.sDisplayName, var2.sDisplayName)) {
                    return true;
                } else {
                    return false;
                }
