    ...
    public boolean equals(Object var1) {
        if (this != var1) {
            if (var1 != null && this.getClass() == var1.getClass()) {
                ...
                if (JceUtil.equals(this.sDisplayName, var2.sDisplayName) && JceUtil.equals(this.iBitRate, var2.iBitRate) && JceUtil.equals(this.iCodecType, var2.iCodecType) && JceUtil.equals(this.iCompatibleFlag, var2.iCompatibleFlag)) {
                    return true;
                } else {
                    return false;
                }
