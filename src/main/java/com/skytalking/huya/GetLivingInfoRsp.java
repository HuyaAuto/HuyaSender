    ...
    public boolean equals(Object var1) {
        if (this != var1) {
            if (var1 != null && this.getClass() == var1.getClass()) {
                ...
                if (JceUtil.equals(this.bIsLiving, var2.bIsLiving) && JceUtil.equals(this.tNotice, var2.tNotice) && JceUtil.equals(this.tStreamSettingNotice, var2.tStreamSettingNotice) && JceUtil.equals(this.bIsSelfLiving, var2.bIsSelfLiving)) {
                    return true;
                } else {
                    return false;
                }
