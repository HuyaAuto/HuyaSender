...
public final class StreamInfo extends JceStruct implements Cloneable {
    ...
    public StreamInfo(String var1, int var2, long var3, long var5, long var7, String var9, String var10, String var11, String var12, String var13, String var14, String var15, int var16, int var17, int var18, int var19, int var20) {
        this.sCdnType = var1;
        this.iIsMaster = var2;
    ...
    public boolean equals(Object var1) {
        if (this != var1) {
            if (var1 != null && this.getClass() == var1.getClass()) {
                ...
                if (JceUtil.equals(this.sCdnType, var2.sCdnType) && JceUtil.equals(this.iIsMaster, var2.iIsMaster) && JceUtil.equals(this.lChannelId, var2.lChannelId) && JceUtil.equals(this.lSubChannelId, var2.lSubChannelId) && JceUtil.equals(this.lPresenterUid, var2.lPresenterUid) && JceUtil.equals(this.sStreamName, var2.sStreamName) && JceUtil.equals(this.sFlvUrl, var2.sFlvUrl) && JceUtil.equals(this.sFlvUrlSuffix, var2.sFlvUrlSuffix) && JceUtil.equals(this.sFlvAntiCode, var2.sFlvAntiCode) && JceUtil.equals(this.sHlsUrl, var2.sHlsUrl) && JceUtil.equals(this.sHlsUrlSuffix, var2.sHlsUrlSuffix) && JceUtil.equals(this.sHlsAntiCode, var2.sHlsAntiCode) && JceUtil.equals(this.iLineIndex, var2.iLineIndex) && JceUtil.equals(this.iIsMultiStream, var2.iIsMultiStream) && JceUtil.equals(this.iPCPriorityRate, var2.iPCPriorityRate) && JceUtil.equals(this.iWebPriorityRate, var2.iWebPriorityRate) && JceUtil.equals(this.iMobilePriorityRate, var2.iMobilePriorityRate)) {
                    return true;
                } else {
                    return false;
                }
